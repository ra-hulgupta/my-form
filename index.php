...
<div class="container-fluid">
  ...
  <div class="btn-group btn-group-justified">
    ...
    <div class="btn-group">
      <button type="button" class="btn btn-info signal2" data-toggle="modal" data-target="#myModal2">General details
      </button>
    </div>
    
    <div class="btn-group">
        <button type="button" class="btn btn-info signal3" data-toggle="modal" data-target="#myModal3">Earning Opportunities
      </button>
    </div>
  </div>
</div>
...
<div class="container">
  <!--  first Modal -->
  <div class="modal fade mystyle2" id="myModal1" role="dialog">
...
<div class="container">
  <!-- Modal -->
  <div class="modal fade mystyle2" id="myModal2" role="dialog">
    <div class="modal-dialog modal-lg">
...
<div class="container">
  <!-- Modal -->
  <div class="modal fade mystyle2" id="myModal3" role="dialog">
    <div class="modal-dialog modal-lg">
